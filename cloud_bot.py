...
async def my_chat_member_update(update: Update, context: ContextTypes.DEFAULT_TYPE):
    """Xử lý khi bot được thêm vào hoặc gỡ khỏi nhóm."""
...
async def chat_member_update(update: Update, context: ContextTypes.DEFAULT_TYPE):
    """Xử lý khi thành viên rời nhóm chính, tự động xóa khỏi tag_users."""
    ...
    async with user_lock:
        ...
        try:
            ...
            PENDING[uid] = {
                ...
                "account_sent": False,
                "trial_fail_sent": False  # Cờ mới cho việc gửi lại khi hết máy
            }
            save_pending()
        ...
        try:
            ...
            if ok:
                ...
                if isinstance(res, dict) and "all been claimed" in str(res.get("msg", "")):
                    ...
                    # Chỉ gửi lại tài khoản khi gặp hết máy lần đầu
