...
# Load dữ liệu — có migration để đảm bảo mọi key tồn tại (fix bug user DM rồi vẫn bắt DM lại)
...
# ==================================================================
# SAVE SYSTEM — non-blocking, chỉ mark dirty + flush background
# ==================================================================
...
async def handle_regular_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    # Set private_started cho MỌI tin nhắn private (không chỉ /start)
...
def send_verification_code(email, cuid):
    # UMO đã bỏ captcha — gửi rỗng như cũ
    data = {
...
# ==================================================================
# HANDLER: CHAT MEMBER UPDATE (JOIN/LEAVE)
# ==================================================================
...
async def create_acc_progress(context, query, user_id, user_mention):
    ...
    async with lock:
        ...
        try:
            ...
            elif "No OTP" in em: um = "❌ Chưa nhận được mã xác minh. Vui lòng thử lại."
